...
**1.2. Usuário:**
Toda pessoa física que acessa e utiliza o V3RCondo, seja na qualidade de:

- **Síndico (manager):** responsável pela administração do condomínio, com acesso a todas as funcionalidades de gestão;
- **Condômino (resident):** morador ou proprietário de unidade, com acesso às funcionalidades de autoatendimento e acompanhamento;
- **Porteiro:** usuário autorizado pelo síndico para registro de visitantes e controle de acesso, com permissões restritas a essa finalidade;
- **Subsíndico e membros do Conselho Fiscal:** condôminos com título atribuído pelo síndico para fins de identificação e comunicação interna, sem permissões adicionais em relação ao papel de condômino;
- **Administrador da plataforma:** usuário interno da V3RTECH com acesso irrestrito para fins de suporte e operação.

O síndico é responsável pelo cadastro e pela gestão dos usuários vinculados ao seu condomínio e responde pelo uso adequado da plataforma por esses usuários.
...
- Utilizar a plataforma de forma lícita, ética e em conformidade com a legislação brasileira;
- Não inserir dados falsos, difamatórios ou que violem direitos de terceiros;
- Não tentar acessar áreas restritas ou dados de outros condomínios;
- Não realizar engenharia reversa, decompilação ou tentativa de extração do código-fonte;
- Não utilizar a plataforma para envio de spam ou comunicações não solicitadas.
...
- Indisponibilidade temporária por manutenção programada ou eventos fora do controle da V3RTECH (caso fortuito ou força maior).
