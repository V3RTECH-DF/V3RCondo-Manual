...
| 05 | ~~`cobranca-05-documentos.png`~~ | **OBSOLETO (17/08/2026)** — o cartão **Documentos que o Asaas precisa** foi removido do produto. O envio de documentos acontece hoje direto no painel do Asaas, fora do V3RCondo; a página não referencia mais este marcador | — | — |
