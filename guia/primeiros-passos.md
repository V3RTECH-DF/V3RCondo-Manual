...
> **Convite por e-mail**
>
> Se você recebeu um convite por e-mail do seu síndico, clique no link do e-mail e siga as instruções para definir sua senha. O vínculo será feito automaticamente.

## Recuperar a senha

Na tela de login, clique em **Esqueci minha senha** e informe seu e-mail. Você receberá um link para redefinir a senha.

![Tela de recuperação de senha](/assets/screenshots/04-recuperar-senha.png)

{: .note }
> **Login com Google**
>
> Usuários que entram com o Google não precisam definir senha — o acesso é gerenciado pela conta Google.
